package
{
	...
	*/
	public class EmbeddedAssets
	{
		...
		[Embed(source = "../lib/graphics/landscapes/4/clouds.png")] private const FLAKIT_ASSET$2082771989:Class;
		[Embed(source = "../lib/graphics/landscapes/4/ground.png")] private const FLAKIT_ASSET$_1413010569:Class;
		[Embed(source = "../lib/graphics/landscapes/4/sky.png")] private const FLAKIT_ASSET$_868115869:Class;
		[Embed(source = "../lib/graphics/landscapes/3/clouds.png")] private const FLAKIT_ASSET$2082767796:Class;
		[Embed(source = "../lib/graphics/landscapes/3/ground.png")] private const FLAKIT_ASSET$_1413014762:Class;
		[Embed(source = "../lib/graphics/landscapes/3/sky.png")] private const FLAKIT_ASSET$_868120920:Class;
		[Embed(source = "../lib/graphics/landscapes/2/clouds.png")] private const FLAKIT_ASSET$2082766707:Class;
		[Embed(source = "../lib/graphics/landscapes/2/ground.png")] private const FLAKIT_ASSET$_1413015851:Class;
		[Embed(source = "../lib/graphics/landscapes/2/sky.png")] private const FLAKIT_ASSET$_868121803:Class;
		[Embed(source = "../lib/graphics/landscapes/1/clouds.png")] private const FLAKIT_ASSET$2082761522:Class;
		[Embed(source = "../lib/graphics/landscapes/1/ground.png")] private const FLAKIT_ASSET$_1413021036:Class;
		[Embed(source = "../lib/graphics/landscapes/1/sky.png")] private const FLAKIT_ASSET$_868127318:Class;
		...
		[Embed(source = "../lib/graphics/house/loveLetter.png")] private const FLAKIT_ASSET$_1952227695:Class;
		[Embed(source = "../lib/graphics/house/mask.png")] private const FLAKIT_ASSET$1332479272:Class;
		...
		[Embed(source = "../lib/audio/ambiance.mp3")] private const FLAKIT_ASSET$416501646:Class;
		[Embed(source = "../lib/audio/enterWater.mp3")] private const FLAKIT_ASSET$_221047897:Class;
		[Embed(source = "../lib/audio/jetpack.mp3")] private const FLAKIT_ASSET$37703755:Class;
		[Embed(source = "../lib/audio/leaveWater.mp3")] private const FLAKIT_ASSET$1515834982:Class;
		[Embed(source = "../lib/audio/pickup.mp3")] private const FLAKIT_ASSET$_837529154:Class;
		...
		public function EmbeddedAssets()
		{
			...
			Library.addImage(new String("graphics/landscapes/4/clouds.png").split("/").join("."), new FLAKIT_ASSET$2082771989);
			Library.addImage(new String("graphics/landscapes/4/ground.png").split("/").join("."), new FLAKIT_ASSET$_1413010569);
			Library.addImage(new String("graphics/landscapes/4/sky.png").split("/").join("."), new FLAKIT_ASSET$_868115869);
			Library.addImage(new String("graphics/landscapes/3/clouds.png").split("/").join("."), new FLAKIT_ASSET$2082767796);
			Library.addImage(new String("graphics/landscapes/3/ground.png").split("/").join("."), new FLAKIT_ASSET$_1413014762);
			Library.addImage(new String("graphics/landscapes/3/sky.png").split("/").join("."), new FLAKIT_ASSET$_868120920);
			Library.addImage(new String("graphics/landscapes/2/clouds.png").split("/").join("."), new FLAKIT_ASSET$2082766707);
			Library.addImage(new String("graphics/landscapes/2/ground.png").split("/").join("."), new FLAKIT_ASSET$_1413015851);
			Library.addImage(new String("graphics/landscapes/2/sky.png").split("/").join("."), new FLAKIT_ASSET$_868121803);
			Library.addImage(new String("graphics/landscapes/1/clouds.png").split("/").join("."), new FLAKIT_ASSET$2082761522);
			Library.addImage(new String("graphics/landscapes/1/ground.png").split("/").join("."), new FLAKIT_ASSET$_1413021036);
			Library.addImage(new String("graphics/landscapes/1/sky.png").split("/").join("."), new FLAKIT_ASSET$_868127318);
			...
			Library.addImage(new String("graphics/house/loveLetter.png").split("/").join("."), new FLAKIT_ASSET$_1952227695);
			Library.addImage(new String("graphics/house/mask.png").split("/").join("."), new FLAKIT_ASSET$1332479272);
			...
			Library.addSound(new String("audio/ambiance.mp3").split("/").join("."), new FLAKIT_ASSET$416501646);
			Library.addSound(new String("audio/enterWater.mp3").split("/").join("."), new FLAKIT_ASSET$_221047897);
			Library.addSound(new String("audio/jetpack.mp3").split("/").join("."), new FLAKIT_ASSET$37703755);
			Library.addSound(new String("audio/leaveWater.mp3").split("/").join("."), new FLAKIT_ASSET$1515834982);
			Library.addSound(new String("audio/pickup.mp3").split("/").join("."), new FLAKIT_ASSET$_837529154);
